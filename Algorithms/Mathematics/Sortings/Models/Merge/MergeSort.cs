using Mathematics.Sortings.Enums;
using Mathematics.Sortings.Models.Base;

namespace Mathematics.Sortings.Models.Merge;

public class MergeSort<T> : SortingBase<T>
	where T : IComparable<T>
{
	public MergeSort() : base(SpaceComplexityType.Linear, TimeComplexityType.Linearithmic, AlgorithmType.ComparisonSort)
	{
	}
