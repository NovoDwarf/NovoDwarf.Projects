...
using Mathematics.App.Maui.UI.Views.Utilities.Sensors;
using Mathematics.App.Maui.UI.Views.Utilities.Tools;
using Mathematics.App.ViewModels.Common;
using Utilities.Extensions;

namespace Mathematics.App.ViewModels.Utilities;
