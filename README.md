...
Это собрание разнообразных алгоритмов, программ и всего остального, чей размер слишком мал для того, чтобы выделить это в отдельный репозиторий. Поэтому это собрано здесь. В решении используется чистый .NET 10.0, для реализации тестов - фреймворк NUnit.
...
- [x] **Постоянный шаг** (Метод ΔT) - это вариант реализации продвижения времени в дискретно-событийном моделировании, суть которого заключается в том, что время системы изменяется согласно какому-то минимально приемлимому отрезку времени ΔT. [Подробнее]().
- [x] **E2E** (Event to Event) - это еще один вариант реализации продвижения времени в дискретно-событийном моделировании, суть которого заключается в том, что... [Подробнее]().

#### Алгоритмы сортировки

**Сортировка слиянием**

- [x] [Слиянием](https://en.wikipedia.org/wiki/Merge_sort) (Merge sort) - суть алгоритма в том, что он рекурсивно сортирует половины массива, а затем комбинирует их в один.
- [] [Каскадное слияние](https://en.wikipedia.org/wiki/Cascade_merge_sort) (Cascade merge sort) -
- [] [](https://en.wikipedia.org/wiki/Oscillating_merge_sort) (Oscillating sort) -
- [] [](https://en.wikipedia.org/wiki/Polyphase_merge_sort) (Polyphase sort) -
...
- [] [](https://en.wikipedia.org/wiki/Library_sort) (Libray sort) -
...
- [] [](https://en.wikipedia.org/wiki/Bitonic_sorter) (Bitonic mergesort) -
...
- [] [](https://en.wikipedia.org/wiki/Samplesort) (Samplesort) -
