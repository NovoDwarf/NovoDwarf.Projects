...
using Aegis.Numerics.Primitives;
...
{
	public SpatialPoint(Float2 position, float radius, float weight)
	{
		Position = position;
		Radius = radius;
		Weight = weight;
...
{
	public SpatialPath(List<Float2> position, float radius, float weight)
	{
		Radius = radius;
		Weight = weight;
	}
	
	public SpatialPath(Float2 position, float radius, float weight)
	{
		Position = position;
		Radius = radius;
		Weight = weight;
