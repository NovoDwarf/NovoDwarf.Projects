namespace Mathematics.Utilities.Formulas;

public static class BoxMullerUtils
{
    public static (double x, double y) BoxMullerStandard()
    {
        double u1, u2;
    ...
    public static (double u, double v) BoxMullerPolar()
    {
        double x, y, s;
        do
        {
