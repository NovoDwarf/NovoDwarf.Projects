...
public class NormalTruncatedDistributionTests
{
	...
	public void Constructor_SetsPropertiesCorrectly()
	{
		...
		using (Assert.EnterMultipleScope())
		{
			...
			Assert.That(truncatedNormal.Minimum, Is.EqualTo(min));
			Assert.That(truncatedNormal.Maximum, Is.EqualTo(max));
		}
	}
	...
	public void Calculate_ReturnsValueWithinBounds()
	{
		...
		var result = truncatedNormal.Distribute();
	...
	public void Calculate_WithWideBounds_ReturnsVariedValues()
	{
		...
		for (var i = 0; i < 100; i++) results.Add(truncatedNormal.Distribute());
	...
	public void GetExpectedValue_AlwaysReturnsNaN()
	{
		...
		var result = truncatedNormal.Expected;
	...
	public void GetVariance_AlwaysReturnsNaN()
	{
		...
		var result = truncatedNormal.Variance;
	...
	public void GetMinValue_ReturnsConstructorMin()
	{
		...
		var result = truncatedNormal.Minimum;
	...
	public void GetMaxValue_ReturnsConstructorMax()
	{
		...
		var result = truncatedNormal.Maximum;
