...
public class ErlangTests
{
    ...
    public void Constructor_WithValidParameters_SetsCorrectProperties()
    {
        ...
        var distribution = new Erlang(shape, rate);
    ...
    {
        Assert.Throws<ArgumentException>(() => new Erlang(0, 1.0));
    }
    ...
    public void Calculate_WithShapeOne_BehavesLikeExponential()
    {
        ...
        var erlang = new Erlang(1, rate);
        var exponential = new Exponential(rate);
        
        var erlangResults = TestsUtils.GenerateSamples<Erlang>(erlang, SampleSize);
        var expResults = TestsUtils.GenerateSamples<Exponential>(exponential, SampleSize);
    ...
    public void Calculate_WithVariousShapes_ReturnsNonNegativeValues()
    {
        ...
        {
            var distribution = new Erlang(shape, 1.0);
            
            var results = TestsUtils.GenerateSamples<Erlang>(distribution, SampleSize);
    ...
    public void Calculate_WithIncreasingShape_ProducesLessVariableResults()
    {
        ...
        var shape1 = new Erlang(1, rate);
        var shape5 = new Erlang(5, rate);
        var shape10 = new Erlang(10, rate);
        
        var results1 = TestsUtils.GenerateSamples<Erlang>(shape1, SampleSize);
        var results5 = TestsUtils.GenerateSamples<Erlang>(shape5, SampleSize);
        var results10 = TestsUtils.GenerateSamples<Erlang>(shape10, SampleSize);
    ...
    {
        var distribution = new Erlang(3, 2.0);
    ...
    {
        var distribution = new Erlang(2, 1.0);
    ...
    public void Calculate_SampleMeanAndVariance_ApproximateTheoretical()
    {
        ...
        var samples = TestsUtils.GenerateSamples<Erlang>(distribution, SampleSize);
